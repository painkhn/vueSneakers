...
<template>
    <div class="flex items-center gap-4 mb-5">
        <svg @click="closeDrawer" class="rotate-180 cursor-pointer opacity-50 hover:opacity-100 hover:-translate-x-1 transition-all" width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
